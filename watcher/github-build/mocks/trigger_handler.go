...
func (fake *TriggerBuildCheckHandler) ServeHTTP(arg1 context.Context, arg2 http.ResponseWriter, arg3 *http.Request) error {
...
func (fake *TriggerBuildCheckHandler) ServeHTTPCallCount() int {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
	return len(fake.serveHTTPArgsForCall)
}

func (fake *TriggerBuildCheckHandler) ServeHTTPCalls(stub func(context.Context, http.ResponseWriter, *http.Request) error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
	fake.ServeHTTPStub = stub
}

func (fake *TriggerBuildCheckHandler) ServeHTTPArgsForCall(i int) (context.Context, http.ResponseWriter, *http.Request) {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
...
func (fake *TriggerBuildCheckHandler) ServeHTTPReturns(result1 error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
...
func (fake *TriggerBuildCheckHandler) ServeHTTPReturnsOnCall(i int, result1 error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
	fake.ServeHTTPStub = nil
...
func (fake *TriggerBuildCheckHandler) Invocations() map[string][][]interface{} {
...
func (fake *TriggerBuildCheckHandler) recordInvocation(key string, args []interface{}) {
...
var _ handler.TriggerBuildCheckHandler = new(TriggerBuildCheckHandler)
