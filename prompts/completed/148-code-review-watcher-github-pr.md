...
completed: "2026-05-24T11:24:43Z"
---
...
<objective>
Run a full code review of watcher/github-pr and generate a fix prompt for each Critical or Important finding.
</objective>
...
Service directory: `watcher/github-pr/`
</context>
...
Run `/coding:code-review full watcher/github-pr` to get a comprehensive review with all specialist agents.
...
**Filename:** `review-watcher-github-pr-<fix-description>.md`
...
<constraints>
- Only change files in `watcher/github-pr/`
